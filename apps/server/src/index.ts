import { createContext } from "@needle-agent/api/context";
import { appRouter } from "@needle-agent/api/routers/index";
import { auth } from "@needle-agent/auth";
...
initLogger({
  env: { service: "needle-agent-server" },
});
